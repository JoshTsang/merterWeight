...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
	public final static String TAG = "MjpegView";
	...
	private final static String host = "http://192.168.0.107";
	private final static String urlCtrl = host + "/decoder_control.cgi?command=";
